...
export async function POST(request: NextRequest) {
  try {
    ...
    if (lower.includes('help') || lower.includes('support') || lower.includes('ticket') || lower.includes('contact team')) {
      ...
      reply = `Thanks for your message about "${msg}". I've notified the team via Telegram. For immediate answers: check the homepage for LIVE $MT stats, tokenomics, utilities and flows, or visit /whitepaper and /developers. How else can I help?`;
    }
