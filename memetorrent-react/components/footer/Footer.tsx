    ...
    <footer className="border-t border-white/10 px-6 py-10 text-xs text-white/50">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-y-3 justify-between">
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-1">
          ...
          <a href="https://jup.ag/swap/SOL-ELywDcVX2WumHm4xEfqF8NdEKaeGCAaq9JmwtjE8pump" target="_blank" className="hover:text-white opacity-60">$MT on Jupiter (external)</a>
        </div>
      </div>
