  ...
  return (
    <footer className="border-t border-white/10 px-6 py-10 text-xs text-white/50">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-y-3 justify-between">
        <div>© {new Date().getFullYear()} MT ECO SYSTEM — Built by FutureT3ch. All core components self-hosted and self-built.</div>
        <div className="flex gap-x-6">
          <a href="https://infinite-wallet.vercel.app/" target="_blank" className="hover:text-white">INFINITE WALLET</a> {/* updated to new production wallet */}
