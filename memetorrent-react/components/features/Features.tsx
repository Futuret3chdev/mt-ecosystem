...
export default function Features() {
  const items = [
    ...
    },
    {
      ...
      desc: 'MT Wallet is our Phantom equivalent. Full key control in-browser, encrypted vaults, QR, send, receive, NFT mint. No MetaMask, no Phantom, no third parties.',
    },
    {
