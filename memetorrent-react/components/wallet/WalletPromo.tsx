      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-x-16 gap-y-10 items-center">
          <div>
            ...
            <div className="text-xs mt-3 opacity-50">Opens the production wallet at https://infinite-wallet.vercel.app/</div> {/* all memetorrent-react wallet launch links updated */}
          </div>
