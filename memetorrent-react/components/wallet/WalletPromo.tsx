      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-x-16 gap-y-10 items-center">
          <div>
            ...
            <p className="mt-6 text-lg opacity-70 max-w-md">INFINITE WALLET is the official gateway. Full control. Built from the ground up for the MT ECO SYSTEM. Looks and feels like the best — because we made it. Infinite possibilities.</p>
            ...
            <div className="text-xs mt-3 opacity-50">Opens the production INFINITE WALLET at https://infinite-wallet.vercel.app/</div> {/* all memetorrent-react wallet launch links updated */}
          </div>
